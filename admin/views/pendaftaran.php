                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                ?>
                                <td><?= $btn_edt ?>
                                    <a class="btn btn-danger btn-sm " href='views/controls/hapus.php?vz=<?= base64_encode($student['id']) ?>' onclick="return confirm('Apakah benar ingin di hapus ?')">Hapus</a>
                                    <a type="button" class="btn btn-sm btn-warning" href="print-pdf.php?print=<?= $student['id'] ?>">Print PDF</a>
                                </td>
